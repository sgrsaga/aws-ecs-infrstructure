...
# 1.4. Create Public Subnets in each AZs in this region(us-east-1) 7 Subnets
# 1.5. Create Private Subnets in each AZs in this region(us-east-1) 7 Subnets
# 1.6. Create Public access Security Group
# 1.7. Create Private Access Security Group
...
# 1.4. Create Public Subnets in all AZs
...
# 1.5. Create Private Subnets in all AZs
